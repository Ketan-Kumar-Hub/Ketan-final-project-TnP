...
document.addEventListener("DOMContentLoaded", () => {
  ...
  onAuthStateChanged(auth, (user) => {
    if (user) {
      ...
      if (userEmailDisplay) {
        userEmailDisplay.innerHTML = `<a href="login.html" style="color:rgb(203, 198, 198); padding: 8px 16px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: 0.3s;">Login/Signup</a>`; // ✅ Show Login Link
